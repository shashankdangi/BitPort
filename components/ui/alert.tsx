  ...
  "flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: "light",
        className:
          "bg-[var(--color-destructive-soft,var(--color-red-50))]  border border-[var(--color-destructive-alpha,var(--color-red-100))] text-foreground [&_[data-slot=alert-icon]]:text-destructive dark:bg-[var(--color-destructive-soft,var(--color-red-950))]/40 backdrop-blur-3xl  dark:border-[var(--color-destructive-alpha,var(--color-red-900))] ",
      },
      {
        variant: "success",
        appearance: "light",
